        ...
        <div class="panel panel-warning" style="">
          <div class="panel-body">
            ...
            <div class="col-md-3" style="text-transform: capitalize;">
                <h6 style="color: red; font-weight: bold; font-size: 14px;"><?php echo $row['first_nm'].'_'.$row['last_nm']; ?></h6><br>
                <h6 style="color: red; font-weight: bold; font-size: 14px;"><?php echo $row['contact']; ?></h6><br>
