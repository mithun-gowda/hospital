            ...
            <div class="col-md-12">
              <table class="table table-bordered" id="example">
                ...
                <tbody>
                  ...
                  $i=1; 
                     $sq=mysqli_query($con,"SELECT * FROM appointment,user where user.u_id=appointment.user_id and did='$user_id' and status!='prescribed' order by bookingfor desc");
                     while($row=mysqli_fetch_array($sq)){
                   ?>
                   <tr>
                    <form action="enter_prescription.php?apid=<?php echo $row['ap_id']; ?>&&uid=<?php echo $row['user_id']; ?>" method="post">
                    <td><?php echo $i++; ?></td>
                    ...
                    <td><?php echo $row['bookingfor'].' '.$row['booktime']; ?></td>
                     ...
                     <td>
                      ...
                      <?php }else if($st=='confirmed'){ ?>
                        <span style="color: green; font-weight: bold;">Confirmed </span><button type="submit" name="savepres" class="btn btn-info">Treatment Details</button>
