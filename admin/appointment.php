...
<body>
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Form to view Appointments</h1>
      </div>
    </div><!--/.row-->
              ...
              <table class="table table-bordered" id="example">
                ...
                <tbody>
                  <?php include 'connection.php'; $i=1; 
                     $sq=mysqli_query($con,"SELECT * FROM appointment,user where user.u_id=appointment.user_id and  status!='prescribed' order by bookingfor desc");
