        ...
        <div class="col-lg-12">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="post" action="discharge2.php">
                  <div class="row"> 
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                  ...
                                  <div class="col-md-4">
                                    <!-- <label>&nbsp;</label> -->
                                    <div class="form-group">
                                        <input onclick="return confirm('are you sure want to discharge this patient?')" type="submit" name="search" class="btn btn-danger" value="Discharge">
                                    </div>
                                  </div>
                        </div>
                  </div>
